...
0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var k=0;k<a.length;++k){var c=a[k];delete a[k];try{c()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var c=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var g=this.createResolveAndReject_();try{a(g.resolve,g.reject)}catch(h){g.reject(h)}};c.prototype.createResolveAndReject_=
...
404]();if("string"===typeof b.redirect)return A(b.redirect);var d=[m.before||null,b.before||null].filter(function(a){return"function"===typeof a});if(0<d.length){var n=function(b,w){var e=d.pop();return"function"!==typeof e?b(f):e(a,c,function(a){return"undefined"===typeof a||!0===a?0<d.length?n(b,w):b(f):a?0<d.length?n(b,w):b(a):b(m.config.errors[403]())},x.get())};return new Promise(n)}return f}}function e(a){var b=a.placeholder;a=a.waitMs;var f=x.state.route,e=new Promise(function(a){var b=c(d(f));
b instanceof Promise?b.then(a):a(b)});return k("await",{src:e,placeholder:b,waitMs:a})}var k=a.h,h=a.Event,l=a.Service,u=a.Store;a=a.customAttribute;void 0===b&&(b=[]);b||console.warn("[Radi:Router] Routes should be set as a second parameter");var m={},v,q,z,r,A=function(a){window.location.hash=a;return!0},B=function(a){for(var b in a)if(a.hasOwnProperty(b)&&a[b].children){var c=B(a[b].children),f;for(f in c)c.hasOwnProperty(f)&&(a[b+f]=c[f])}return a},C=function(a,b,c,d){var f=a.split(/[\?&]/).slice(1).map(function(a){return a.split("\x3d")}).reduce(function(a,
b){var c;return Object.assign(a,(c={},c[b[0]]=b[1],c))},{}),w=a.match(b[0]);this.path=a;this.key=d;this.query=f;this.cmp=c[d]||{};this.params=this.cmp.data||{};for(a=0;a<b[1].length;a++)this.params[b[1][a]]=w[a+1]},D=function(){for(var a=[],b=arguments.length;b--;)a[b]=arguments[b];return a.reduce(function(a,b){return b?a.concat(b):a},[])};h=new h(window,"hashchange",function(a){return{hash:location.hash.substr(1)||"/"}});var x=(new u({route:h({hash:location.hash.substr(1)||"/"}).map(function(a){return a.hash}),
params:{},query:{},current:{title:null,tags:[],meta:{}}})).map(function(a,b){b=window.location.hash.substr(1)||"/";if(z===b)var c=r;else{v||(v=Object.keys(m.routes));if(!q){c=v;var d=c.length,f=Array(d);for(--d;0<=d;d--){var e=d;var g=c[d].split("/");for(var n=[],k=[],h=0;h<g.length;h++)58===g[h].charCodeAt(0)?(n.push("([^/]+?)"),k.push(g[h].substr(1))):""!==g[h]&&n.push(g[h]);g=[new RegExp("^/"+n.join("/")+"(?:[/])?(?:[?\x26].*)?$","i"),k];f[e]=g}q=f}c=!1;for(f=0;f<q.length;f++)if(q[f][0].test(b)){r=
new C(b,q[f],m.routes,v[f]);c=!0;break}z=b;c=c?r:{key:null}}c=c||{};window.scrollTo(0,0);f=c.cmp&&c.cmp.title;d=a.route.split("#");l.Title.set(f);return{route:d[0],hash:d[1],last:a.active,location:b,params:c.params||{},query:c.query||{},active:c.key||"",current:{title:"object"===typeof f?f:{text:f},tags:c.cmp&&c.cmp.tags||[],meta:c.cmp&&c.cmp.meta||{}}}});a("href",function(a,b){return"#"===b[0]?x.listener(function(a){return"#"+a.route+b}):"#"+b},{allowedTags:["a"],addToElement:!0});var t=new u({prefix:null,
text:null,suffix:"Radi.js",seperator:" | "}),E=function(a,b){return Object.assign({},a,{prefix:b})},F=function(a,b){return Object.assign({},a,{suffix:b})},G=function(a,b){return Object.assign({},a,{text:b})},H=function(a,b){return Object.assign({},a,{seperator:b})},p=function(){this.onUpdate=this.onUpdate.bind(this);t.subscribe(this.onUpdate)};p.prototype.setPrefix=function(a){return t.dispatch(E,a)};p.prototype.setSuffix=function(a){return t.dispatch(F,a)};p.prototype.set=function(a){return t.dispatch(G,
a)};p.prototype.setSeperator=function(a){return t.dispatch(H,a)};p.prototype.onUpdate=function(a){a=a||{};var c=a.text||b.title&&b.title.text||a.text,d=D(b.title&&b.title.prefix||a.prefix,c,b.title&&b.title.suffix||a.suffix).join(a.seperator);d&&document.title!==d&&(document.title=d);a.text&&c!==a.text&&this.set(null)};u=b.beforeEach;h=b.afterEach;a=function(a,c){var d=b.errors&&b.errors[a];return d?"function"===typeof d?d:function(){return d}:c};m={config:{errors:{404:a(404,function(){return k("div",
{},"Error 404: Not Found")}),403:a(403,function(){return k("div",{},"Error 403: Forbidden")})}},before:u,after:h,routes:B(b.routes),write:A,Router:e};l.add("routerStore",function(){return x});l.add("Title",function(){return new p});l.add("Router",function(){return e});return m};window&&(window.RadiRouter=b);a.version="0.5.0";a.default=b;Object.defineProperty(a,"__esModule",{value:!0})});
